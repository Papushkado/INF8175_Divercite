        ...
        def alpha_beta_minimax(state: GameState, depth: int, alpha: float, beta: float, maximizing_player: bool) -> float:
            ...
            if maximizing_player:
                ...
                for action in actions:
                    ...
                    if beta <= alpha:
                        break  # Coupure
                return max_eval, best_action  # Retourner la meilleure valeur et action
            else:
                min_eval = float('inf')
                best_action = None
                actions = state.get_possible_light_actions()
                ...
                for action in actions:
                    ...
                    if beta <= alpha:
                        break  # Coupure
                return min_eval, best_action  # Retourner la meilleure valeur et action
