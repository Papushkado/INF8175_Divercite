...
class MyPlayer(PlayerDivercite):
    ...
    def compute_action(self, current_state: GameState, **kwargs) -> Action:
        ...
        """
        En partant du principe qu'une cité << Ressource, on ne fait de l'aléa que sur la cité pour le premier coup, pas sur tous les coups possibles
        """
